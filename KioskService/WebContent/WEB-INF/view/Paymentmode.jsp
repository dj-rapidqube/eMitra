...
<body style="background: url(img/inner-bg.png); background-size: cover;">
								...
								<div class="row">
									<div class="billmidmain">
										...
										<div class="feildone">
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	<div class="modal-body">
																		<p>
																			<strong>Cash Mode Not Available in BSNL Service.</strong>
																		</p>
											...
											<!-- <div class="col-md-4 paymentone">
												<a href="#" onclick="biomatric()" id="fingurePaymewnt"> <img
													src="img/thumb.png" />
								...
								<div class="modal fade" id="showAdharPayModel" role="dialog"
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-body">
												<p>
													<strong>Are you carrying the AadharPay with you through which<br> you want to make the payment? </strong>
												</p>

											</div>
											<div class="modal-footer" style="text-align: center">
												<button type="submit" class="btn btn-default getone"
													onclick="yesCallPayementAdharPay();">Yes </button>
												<button type="submit" class="btn btn-default getone"
													>No</button>
											</div>
	...
	<script type="text/javascript">
					...
					success : function(trans){
						...
						if(valArr[0]=='SUCCESS'){
							...
							console.log($("#emitraTransactionId").val());
						  	...
						  	$.ajax({
								url : '/KioskService/cashAcceptor/'+amt+'/'+trnsid+'/',
								type : "POST",
								success : function(data) {
								//	alert(data);
								//	console.log(data);
		...
		/* function yesCallPayementAdharPay()
		{
			document.getElementById('yesorno').value=3;
			document.getElementById('payment112').action="paymentByBiomatric";
			document.getElementById('payment112').method="post";
			document.getElementById('payment112').submit();
		} */
