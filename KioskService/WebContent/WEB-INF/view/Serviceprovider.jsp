                        ...
                        <div class="innermid">
                            <div class="container main_row">
                                ...
                                <div class="row sliderow">
                                    ...
                                    <h1 class="">UTILITY BILLS</h1>
                                        <ul id="" class="servicepro slider">
                                            <li>
                                                <div class="oneservices">
                                                    <a href="javascript:void(0);"  onclick="getSP('1214','AIRTEL')" class="panel">
                                                        <img src="img/Logos/Airtel.png" alt="" />
                                                        <h2>Airtel</h2>
                                                    </a>
                                                </div>
                                                 </li>
                                                ...
                                                <div class="oneservices">
                                                    <a href="javascript:void(0);" onclick="getSP('1219','Vodafone')" class="panel">
                                                        <img src="img/Logos/vodafone.png" alt="" />
                                                        <h2>Vodafone</h2>
                                                    </a>
                                                </div>
                                                </li>
                                             ...
                                             <li>
                                               <div class="oneservices">
                                                    <a href="javascript:void(0);" onclick="getSP('1220','IDEA')" class="panel">
  											...
  											<li>
                                                  <div class="oneservices">
                                                    <a href="javascript:void(0);"  onclick="getSP('2575','BSNL')" class="panel">
