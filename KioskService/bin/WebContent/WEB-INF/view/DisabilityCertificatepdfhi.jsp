...
<body style="background: url(img/inner-bg.png); background-size: cover;">
								...
								<div class="row">
									<div class="billmidmain">
										...
										<form id="govtpdf">
											...
											<input type="hidden" name="addhaarid" id="token" value="${token}"  > 
											<input type="hidden" name="certificateUrl" value="${url}">
											<input type="hidden" name="serviceName" value="${serviceName}">
											<input type="hidden" name="certificateDetails" id="certificateType" value="${certificateType}"  >
											<%-- <input type="hidden" name="certificateYear" id="certificateYear" value="${certificateYear}"  > --%>
										...
										<div class="twobtn">
											...
											<button type="button" class="panel btn btn-default getone"
												data-toggle="modal" data-target="#myModal">प्रमाणपत्र छापें</button>
										</div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-body" style="text-align: center">
						<p>क्या आप वाकई प्रमाणपत्र का छायाचित्र  लेना चाहते हैं	?</p>
						<p>
							शुल्क <i class="fa fa-inr" aria-hidden="true"></i>10 प्रति प्रतिलिपि होगा.
						</p>
					</div>
    ...
    function openit()
    {
    	...
    	document.getElementById('govtpdf').action="DisabilityServicePaymentmode";
    ...
    function no()
    {
    	...
    	$.ajax({
			url : '/KioskService/deletedownload/',
			type : "POST",
    ...
    function abc(){
    	...
    	iframeobj.src= '<%= request.getAttribute("url1")%>#toolbar=0&navpanes=0&scrollbar=0'
    	    }
    setTimeout(function(){ 
		 abc();
	}, 1000);
