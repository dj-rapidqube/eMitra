							...
							<div class="container main_row">
								...
								<div class="row">
									<div class="billmidmain">
										...
										<span class="text-info">Application For Grant Under National Horticulture
										 Mission/National Agriculture developement Scheme</span>
...
<div class="clearfix"></div>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label eformclass"
																		for="RelationType">Name of Component/Activity</label>

																	<div class="col-sm-7">
																		<select id="Name_of_Component/Activity" name="Name_of_Component/Activity"
																			class="form-control  cal" required>
																			<option selected disabled>Organic Farming Vermi Compost</option>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label eformclass"
																		for="RelationType">Land leased/owned 
																		by the farmer </label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-4 control-label" for="irrigated">Total available land to 
																	farmer/applicant (in Hectares)</label>
								...
								<thead>
								<tr>
								<th><label class="control-label col-sm-4">Farmer/Organization/Applicant Name</label></th>
								<th><label class="control-label col-sm-4">Gender</label></th>
								<th><label class="control-label col-sm-4">Relation</label></th>
								<th><label class="control-label col-sm-4">Father/Husband Name</label></th>
								<th><label class="control-label col-sm-4">Caste Category</label></th>
								<th><label class="control-label col-sm-4">Farmer's Class</label></th>
								...
								<tbody >
								<tr>
								<th><input type="text" class="form-control col-sm-12 eformclass EformEnalphabetWithSpaceDot" name="Farmer/Organization/Applicant Name" data-msg="Please provide correct field" required></th>
								<th><select id ="Gender" name="Gender" class="form-control col-sm-12 " required>
                                   <option selected disabled>Select</option>
								  <option>Male</option>
								...
								<th><select id ="Relation" name="Relation" class="form-control col-sm-12 " required>
                                   <option selected disabled>Select</option>
								  <option>Father</option>
                                  <option>Husband</option>
								  </select></th>
								...
								<th><input type="text" class="form-control col-sm-12 eformclass EformEnalphabetWithSpaceDot" name="Caste" data-msg="Please provide an accurate 'Caste'. Accepted values are alphabets, spaces and dot only [For e.g., sc S.K.]. No Special characters are being accepted." required></th>
                                     <th><select id ="caste" name="caste" class="form-control col-sm-12 " required>
                                   <option selected disabled>Select</option>
								  <option>OBC</option>
                                  <option>SBC</option>
								   <option>SC</option>
                            ...
                            <th><select id="FarmerClass" name="FarmerClass" class="form-control col-sm-12 " required>
								<option selected disabled>Select</option>
							...
							<th></th>								
								...
								<tr>
								<th><input type="text" class="form-control col-sm-12 eformclass EformEnalphabetWithSpaceDot" name="FarmerApplicantNameMulti2" id="FarmerApplicantNameMulti2" data-msg="Please provide correct field"> </th>
								<th><select id ="GenderMulti2" name="GenderMulti2" class="form-control col-sm-12 " >
                                   <option selected disabled>Select</option>
								  <option>Male</option>
                                  <option>Female</option>
								  <option>Other</option>
								...
								<th><input type="text" class="form-control col-sm-12 eformclass EformEnalphabetWithSpaceDot" name="appname2" id="appname2" data-msg="Please provide an accurate 'Caste'. Accepted values are alphabets, spaces and dot only [For e.g., sc S.K.]. No Special characters are being accepted."></th>
                                    
								 <th><select id="casteMuti2" name="casteMuti2" class="form-control col-sm-12 ">
                                   <option selected disabled>Select</option>
								  <option>OBC</option>
                                  <option>SBC</option>
								   <option>SC</option>
                            ...
                            <th><select id="FarmerClass2" name="FarmerClass2" class="form-control col-sm-12 ">
								<option selected disabled>Select</option>
								  <option>Marginal</option>
                                  <option>Other</option>
								     <option>Small</option>
							...
							<th></th>								
								...
								<tr>
								<th><input type="text" class="form-control col-sm-12 eformclass EformEnalphabetWithSpaceDot" name="FarmerApplicantNameMulti3" id="FarmerApplicantNameMulti3" data-msg="Please provide correct field"> </th>
								<th><select id ="GenderMulti3" name="GenderMulti3" class="form-control col-sm-12 " >
                                   <option selected disabled>Select</option>
								  <option>Male</option>
                                  <option>Female</option>
								  <option>Other</option>
								...
								<th><input type="text" class="form-control col-sm-12 eformclass EformEnalphabetWithSpaceDot" name="appname3" id="appname3" data-msg="Please provide an accurate 'Caste'. Accepted values are alphabets, spaces and dot only [For e.g., sc S.K.]. No Special characters are being accepted."></th>
                                    
								 <th><select id="casteMuti3" name="casteMuti3" class="form-control col-sm-12 ">
                                   <option selected disabled>Select</option>
								  <option>OBC</option>
                                  <option>SBC</option>
								   <option>SC</option>
                            ...
                            <th><select id="FarmerClass3" name="FarmerClass3" class="form-control col-sm-12 ">
								<option selected disabled>Select</option>
								  <option>Marginal</option>
                                  <option>Other</option>
								     <option>Small</option>
							...
							<th></th>								
								...
								<tr>
								<th><input type="text" class="form-control col-sm-12 eformclass EformEnalphabetWithSpaceDot" name="FarmerApplicantNameMulti4" id="FarmerApplicantNameMulti4" data-msg="Please provide correct field"> </th>
								<th><select id ="GenderMulti4" name="GenderMulti4" class="form-control col-sm-12 " >
                                   <option selected disabled>Select</option>
								  <option>Male</option>
                                  <option>Female</option>
								  <option>Other</option>
								...
								<th><input type="text" class="form-control col-sm-12 eformclass EformEnalphabetWithSpaceDot" name="appname2" id="appname2" data-msg="Please provide an accurate 'Caste'. Accepted values are alphabets, spaces and dot only [For e.g., sc S.K.]. No Special characters are being accepted."></th>
								 ...
								 <th><select id="casteMuti4" name="casteMuti4" class="form-control col-sm-12 ">
                                   <option selected disabled>Select</option>
								  <option>OBC</option>
                                  <option>SBC</option>
								   <option>SC</option>
                            ...
                            <th><select id="FarmerClass4" name="FarmerClass4" class="form-control col-sm-12 ">
								<option selected disabled>Select</option>
								  <option>Marginal</option>
                                  <option>Other</option>
								     <option>Small</option>
							...
							<th></th>								
								...
								<tr>
								<th><input type="text" class="form-control col-sm-12 eformclass EformEnalphabetWithSpaceDot" name="FarmerApplicantNameMulti5" id="FarmerApplicantNameMulti5" data-msg="Please provide correct field"> </th>
								<th><select id ="GenderMulti5" name="GenderMulti5" class="form-control col-sm-12 " >
                                   <option selected disabled>Select</option>
								  <option>Male</option>
                                  <option>Female</option>
								  <option>Other</option>
								...
								<th><select id="Relation5" name="Relation5" class="form-control col-sm-12 ">
                                   <option selected disabled>Select</option>
								  <option>Father</option>
                                  <option>Husband</option>
								  </select></th>
								...
								<th><input type="text" class="form-control col-sm-12 eformclass EformEnalphabetWithSpaceDot" name="appname5" id="appname5" data-msg="Please provide an accurate 'Caste'. Accepted values are alphabets, spaces and dot only [For e.g., sc S.K.]. No Special characters are being accepted."></th>
                                    
								 <th><select id="casteMuti5" name="casteMuti5" class="form-control col-sm-12 ">
                                   <option selected disabled>Select</option>
								  <option>OBC</option>
                                  <option>SBC</option>
								   <option>SC</option>
                            ...
                            <th><select id="FarmerClass5" name="FarmerClass5" class="form-control col-sm-12 ">
								<option selected disabled>Select</option>
								  <option>Marginal</option>
                                  <option>Other</option>
								     <option>Small</option>
							...
							<th></th>								
													...
													<div class="form-group col-md-12">
																	<label class="col-sm-6 control-label eformclass"
																		for="sourceofirr">Khasra / Murabba Number on which Programme/Activity is availed </label>

																	<div class="col-sm-6">
																		<input type="text" class="form-control eformclass col-sm-12 EformEnalphabetWithSpacehyphendot " required id="KhasraNumber" name="KhasraNumber /MurabbaNumber" data-msg="Please provide an accurate 'Khasra/Murabba number'" />
																	</div>
																</div>
													...
													<div class="widget-box">
														...
														<div class="widget-body">
															<div class="widget-main">
																...
																<div class="form-group col-md-12">
																	<span class="text-success">The information provided by me is true to the best of my knowledge. As per policy, I will use the subsidy myself and will not misuse it. I hereby further state that, i have not received any subsidy from any organisation or scheme associated with this program. </span>
																</div>
