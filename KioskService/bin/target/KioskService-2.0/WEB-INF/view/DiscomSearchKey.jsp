                                    ...
                                    <div class="billmidmain">
                                        ...
                                        <div class="feildone" style="text-align:center">
                                            <div class="col-md-6 col-md-offset-3">
                                                <div class="col-md-4">
                                                    <div class="billid">
                                                        <label for="exampleInputEmail1" class="bmd-label-floating">K-Number<span style="color:red;">*</span></label>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
    ...
    <script type="text/javascript" src="js/app-inner.js"></script>
  	...
  	$(function() {
		$("#checkForm").on('click',function() {
			...
			$("#errKNumber").html('');
			if( $("#k_Number").val()==''){
				$("#errKNumber").html('<p style="color:red;float: left;">* Enter DISCOM K-Number</p>');
				$("#k_Number").focus();
