                            ...
                            <div class="container main_row">
                                <div class="row">
                                    ...
                                    <div class="billmidmain">
                                        <h1>कृपया अपने ई-मित्र ट्रांन्जेकशन का विवरण दर्ज करें</h1>
                                        ...
                                        <div class="feildone" style="text-align:center">
                                            <div class="col-md-6 col-md-offset-3">
                                                <div class="col-md-4">
                                                    <div class="billid">
                                                        <label for="exampleInputEmail1" class="bmd-label-floating">ट्रांन्जेकशन आईडी<span style="color:red;">*</span> </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="billidright">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" name="transId" autocomplete="off" id="transId" placeholder="ट्रांन्जेकशन आईडी दर्ज करें">
										   ...
										   <div class="twobtn">
                                                ...
                                                <button class="btn btn-default getone" id="checkForm" type="button">दर्ज करें</button>
