...
<body style="background: url(img/inner-bg.png); background-size: cover;">
    ...
    <div id="wrapper">
        <div id="mask">
            ...
            <div id="fill" class="item stateinfo">
                <div class="content">
                    ...
                    <div class="fourservices">
                        <div class="innermid">
                            <div class="container main_row">
                                <div class="row circle-container">
                                    <div class="billmidmain">
                                        <h1 class=""> जिला प्रशासन</h1>

                                        <div class="col-md-6 ">
                                            <div class="grevanceservices">
                                                <a href="allEmployeeDetails" class="panel">


                                                    <span>समस्त अधिकारी</span>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="grevanceservices">
                                                <a href="designationOfDepartment" class="panel">


                                               <span>पद अनुसार अधिकारी</span>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="button_div">
                                <a href="districtDepartment" class="panel">
