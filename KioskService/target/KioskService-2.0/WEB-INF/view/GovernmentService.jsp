                    ...
                    <div class="fourservices">
                        <div class="innermid">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="billidright">
                                                        <div class="form-group">
                                                          	<%-- <input type="text" class="form-control" required="required" autocomplete="off" name="tokenId" id="tokenId" placeholder="Enter Transaction Id">
                            ...
                            <div class="button_div">
                                <a href="governmentservice11" class="panel">
    ...
    <script type="text/javascript" src="js/app-inner.js"></script>
  	...
  	$(function() {
		...
		//	alert("dfsgfdh");
			$("#errTokenId").html('');
			if( $("#tokenId").val().trim()==''){
				$("#errTokenId").html('<p style="color:red;float: left;">* Please enter Token Id</p>');
				$("#tokenId").focus();
