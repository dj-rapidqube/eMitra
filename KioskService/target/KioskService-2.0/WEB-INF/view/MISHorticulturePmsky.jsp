							...
							<div class="container main_row">
								...
								<div class="row">
									<div class="billmidmain">
										...
										<span class="text-info">Application for subsidy under 
										Pradhan Mantri Krishi Sinchai Yojana (PMKSY) for Micro Irrigation by Drip Online (Wide) Irrigation</span>
											...
											<form id="defaultForm" method="post"
												...
												<div class="col-md-12">
													...
													<div class="widget-header">
															<h4 class="widget-title">Personal Detailss</h4>
															...
															<div class="form-group col-md-6 required">
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-4 control-label eformclass"
																		for="FatherHusbandName">Beneficiary's Name </label>
													...
													<div class="widget-box">
													 <div class="widget-body">
														...
														<div class="clearfix"></div>
															...
															<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label"
																		for="MobileNumber">LandLine Number </label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label eformclass"
																		for="RelationType">Whether farmer or any of his family member has availed any subsidy through
																		 Micro Irrigation Scheme of Government in the last few years?</label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-4 control-label" for="name">Land Owned by Applicant(In hecters) </label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label eformclass"
																		for="RelationType">Year of Installation </label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-4 control-label" for="name">Cropped Area (in hectares)</label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label" for="irrigated">Khasra / Murabba Number on which 
																	MI should be installed</label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-4 control-label eformclass"
																		for="FatherHusbandName">Crop proposed to be grown</label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label eformclass"
																		for="RelationType">Size of HDPE / ALLM </label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-4 control-label eformclass"
																		for="FatherHusbandName">Crop for which MI Set is required</label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label eformclass"
																		for="RelationType">Whether MI Set is for Plantation crops or intercropping crop </label>

																	<div class="col-sm-7">
																		<select id="Name_of_Component/Activity" name="Name_of_Component/Activity"
																			class="form-control  cal" required>
																			<option selected disabled>Select</option>
																			<option>Plantation Crop</option>
																			<option>Intercropping Crop</option>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-4 control-label eformclass"
																		for="FatherHusbandName">Name of Intercropping Crop</label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label eformclass"
																		for="FatherHusbandName">Total area for micro irrigation</label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-4 control-label eformclass"
																		for="FatherHusbandName">Source of Water</label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label eformclass"
																		for="RelationType">Type Of Well</label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-4 control-label"
																		for="MobileNumber">Water level (in meters)  </label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label eformclass"
																		for="RelationType">If Irrigation is done through canal,
																		 then any other water harvesting structure available?</label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-4 control-label eformclass"
																		for="FatherHusbandName">Operation time of the Well per day </label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label eformclass"
																		for="FatherHusbandName">If yes specify size of pond(Length x Breadth x Height)</label>
																		<div class="col-md-12"> -->
									<div class="col-md-12">
												
														
															<h4 class="widget-title">If yes specify size of pond(Length x Breadth x Height) </h4>
														</div>
														
														<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label eformclass"
																		for="FatherHusbandName">Length </label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-4 control-label eformclass"
																		for="FatherHusbandName">Breadth</label>
																...
																<div class="form-group col-md-6 required">
																	<label class="col-sm-5 control-label eformclass"
																		for="FatherHusbandName">Height </label>
